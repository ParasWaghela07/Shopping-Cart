...
//     return (
//       <div className="flex flex-col justify-center items-center gap-y-10 h-[100vh] w-[100vw] bg-gray-900 text-white overflow-x-hidden overflow-y-hidden">
...
//         <button className="font-semibold bg-black p-2 text-white rounded-lg text-2xl hover:bg-gray-700 transition duration-200"  onClick={()=>{navigate('/signup1')}}>SIGN UP</button>
//         </div>
//       </div>
//     );
// }
