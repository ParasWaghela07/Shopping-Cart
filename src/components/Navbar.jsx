            ...
            <div className="max-w-[1200px]  mx-auto h-full flex justify-between items-center relative">
                ...
                <NavLink to="/Home">
...

                 {
                    ...
                    {
                       cartData?.length>0 &&
                       <div className="text-white bg-orange-400 rounded-full w-[18px] h-[18px] flex justify-center items-center text-[12px] absolute -right-1 top-5 xs:top-4 sm:top-7 lg:top-6 animate-bounce">{cartData?.length}</div>
                    }
                    </NavLink>
                 }
